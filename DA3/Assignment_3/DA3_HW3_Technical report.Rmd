...
On the holdout set for my chosen model, the Random Forest, the expected loss is 0.04. This is even smaller than what I got for the train data. Below is the confusion table for the model, showing the choices made by the model, in comparison to the actual values. Based on this the model performance is the following:

```{r, echo=FALSE, out.width="50%", fig.cap="Confision matrix for Random Forest", fig.align = 'center'}
library(kableExtra)
knitr::include_graphics("https://raw.githubusercontent.com/DaniDataScience/DA_3/main/DA3/Assignment_3/plot_cm_rf.png")
```
