...
I built 3 models, Logit, LASSO and Random Forest. Looking at results CV results from prediction, the X3 model gave the best prediction results, followed by the random forest. 
...
The expected loss is 0.4%, meaning the expected loss per purchase is xxx. This is lower to the xxx of the worst model, meaning that building a better model yielded in xxx savings.
