...
I built 3 models, Logit, LASSO and Random Forest. The X3 model gave the best prediction results, followed by the random forest. I selected the classification threshold as xxx with an algorythm, which is very close to the formula of 1/(1+7)=0.125. 
